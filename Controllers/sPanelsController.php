<?php 
	...
	class sPanelsController 
	{
		...
		public function index_static( $get = array() )
		{
			...
			echo '<center style="background:#81FF81">static::sPanelsController</center>';

			if( !empty($get) ) var_dump( $get );

			$buttons = array( 
					'0' => array( '/catalog/solarPanels' , 'Сонячні панелі' , 'active' ),
