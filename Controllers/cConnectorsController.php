<?php 
	...
	class cConnectorsController 
	{
		...
		public function index_static( $get = array() )
		{
			...
			echo '<center style="background:#81FF81">static::cConnectorsController</center>';
			...
			$buttons = array( 
					...
					'2' => array( '/catalog/cablesConnectors' , 'Кабелі і конектори' , 'active' ),
					'3' => array( '/catalog/mountingStructures' , 'Монтажні конструкції' , 'NULL' ),
			...
			$sult = array( 
					...
					'2' => array( 'Кабелі і конектори' , 'active' ),
				);
