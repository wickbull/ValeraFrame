<?php 
	...
	class invertersController 
	{
		...
		public function index_static( $get = array() )
		{
			...
			echo '<center style="background:#81FF81">static::invertersController</center>';

			if( !empty($get) ) var_dump( $get );

			$buttons = array( 
					'0' => array( '/catalog/solarPanels' , 'Сонячні панелі' , 'NULL' ),
					'1' => array( '/catalog/inverters' , 'Інвертори' , 'active' ),
